...
<FORM enctype="multipart/form-data" METHOD="post" NAME="input_form" action="input_reply_ok.php">          
<!-- 글쓴이시작 -->
					<TR> 
...
<!-- 제목시작 -->
					<TR> 
				        ...
				        <TD ALIGN=left VALIGN=middle>
						      <INPUT TYPE=text NAME="title" SIZE='54' MAXLENGTH=40	VALUE="Re:<?echo $title?>">          
						</TD>
					</TR>
   <!-- 제목끝 -->
  <!-- 내용시작 -->
				   ...
				   <tr>
						<TD colspan="2" ALIGN=left VALIGN=top>
							  <TEXTAREA NAME="content" ROWS=7 COLS="70"><?echo $content?></TEXTAREA>
						    <BR>
							  <FONT  COLOR="#000000"> 
						</TD>
				   </TR>
	<!--내용 끝-->
			...
			<!--첨부화일 시작 -->
				  ...
				  <INPUT TYPE="hidden" NAME="b_idx" value="<?echo $b_idx?>" SIZE=25 >		           
