...
Class InvoiceClass{
	...
	*/	
	...
	function readInvoice($conn_id, $pi_no){
	...
	#	echo $sql_invoice;
		...
		$result = mysqli_query($conn_id,  $sql_invoice ) or die("Couldn t execute query.".mysql_error());
	...
	//	echo $sql_eqp;
		...
		$result = mysqli_query($conn_id,  $sql_eqp ) or die("Couldn t execute query.".mysql_error());
		$i=0;
	...
	#		log_message('debug', $sql_eqp_dtl);
			...
			$result2 = mysqli_query($conn_id,  $sql_eqp_dtl ) or die("Couldn t execute query.".mysql_error());
			...
			$result3 = mysqli_query($conn_id,  $sql_prd_req ) or die("Couldn t execute query.".mysql_error());
		...
		$result2 = mysqli_query($conn_id,  $sql_eqp_opt ) or die("Couldn t execute query.".mysql_error());
		...
		$result2 = mysqli_query($conn_id,  $sql_part ) or die("Couldn t execute query.".mysql_error());
	...
	#	echo $sql_packing;
		...
		$result2 = mysqli_query($conn_id,  $sql_packing ) or die("Couldn t execute query.".mysql_error());
