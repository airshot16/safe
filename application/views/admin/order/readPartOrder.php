<?php
Class PartOrderClass{

	function readPartOrder($conn_id, $pi_no, $swp_no){
	...
	function getPartOrderMailCtnt($conn_id, $ctnt, $pi_no, $swp_no){
		...
		$result = mysqli_query($conn_id,  $sql_part ) or die("Couldn t execute query.".mysql_error());
		$row = mysqli_fetch_array($result);
